...
const CitiesSystem: React.FC<Props> = ({ deleteItem }) => {
    ...
    const handleSubmit = async (e: React.FormEvent): Promise<void> => {
        ...
        const apiUrl = process.env.REACT_APP_API_URL + 'api/cities/' // Замініть на свій URL
